...
models_to_download = [
    {
        "path": os.path.join(
            ...
            "..",
            "models",
            "accent_id_commonaccent_xlsr_en_english",
            "wav2vec2.ckpt",
        ),
        "url": "https://huggingface.co/speechbrain/lang-id-commonlanguage_ecapa/resolve/main/embedding_model.ckpt",
        "description": "Accent Detection Model",
    },
    {
        "path": os.path.join(
            os.path.dirname(__file__),
